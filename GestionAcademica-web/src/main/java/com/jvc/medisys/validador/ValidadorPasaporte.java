 ...
 * @author Danny
 */
@FacesValidator("ValidadorPasaporte")
public class ValidadorPasaporte implements Validator {
    ...
    public void validate(FacesContext fc, UIComponent uic, Object value) throws ValidatorException {
        ...
        if (!matcher.matches()) {
            String mensaje = "Error: " + FacesUtils.getResourceBundle().getString("pasaporteIncorrecto") + ".";
